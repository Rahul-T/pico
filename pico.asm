...
main(int argc, char *argv[]) {
  ...
  16:	e8 27 04 00 00       	call   442 <captsc>
	drawHeader();
  1b:	e8 d0 00 00 00       	call   f0 <drawHeader>
...
drawFooter() {
  ...
  20:	68 e0 00 00 00       	push   $0xe0
  25:	68 a0 08 00 00       	push   $0x8a0
  2a:	6a 18                	push   $0x18
  2c:	6a 00                	push   $0x0
  2e:	e8 1f 04 00 00       	call   452 <updatesc>
int
main(int argc, char *argv[]) {
	captsc((void*) manageInput);
	drawHeader();
  ...
  38:	6a 00                	push   $0x0
  3a:	6a 00                	push   $0x0
  3c:	e8 79 03 00 00       	call   3ba <read>
	freesc();
  41:	e8 04 04 00 00       	call   44a <freesc>

	exit();
  46:	e8 57 03 00 00       	call   3a2 <exit>
  4b:	66 90                	xchg   %ax,%ax
  4d:	66 90                	xchg   %ax,%ax
  4f:	90                   	nop

00000050 <manageInput>:
drawFooter() {
	updatesc(0, 24, " PRESS ENTER TO CLOSE                                                           ", UI_COLOR);
}
...
manageInput(int c) {
  ...
  53:	83 ec 08             	sub    $0x8,%esp
	updatesc(10, 10, "hello", 0x07);
  56:	6a 07                	push   $0x7
  58:	68 20 08 00 00       	push   $0x820
  5d:	6a 0a                	push   $0xa
  5f:	6a 0a                	push   $0xa
  61:	e8 ec 03 00 00       	call   452 <updatesc>
}
...
printfile(int fd)
{
  ...
  78:	eb 1d                	jmp    97 <printfile+0x27>
  7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		if (write(1, buf, n) != n) {
  80:	83 ec 04             	sub    $0x4,%esp
  83:	53                   	push   %ebx
  84:	68 40 0c 00 00       	push   $0xc40
  89:	6a 01                	push   $0x1
  8b:	e8 32 03 00 00       	call   3c2 <write>
  90:	83 c4 10             	add    $0x10,%esp
  93:	39 c3                	cmp    %eax,%ebx
  95:	75 2d                	jne    c4 <printfile+0x54>
void
printfile(int fd)
{
	int n;
  ...
  9f:	68 40 0c 00 00       	push   $0xc40
  a4:	56                   	push   %esi
  a5:	e8 10 03 00 00       	call   3ba <read>
  aa:	83 c4 10             	add    $0x10,%esp
  ad:	83 f8 00             	cmp    $0x0,%eax
  b0:	89 c3                	mov    %eax,%ebx
  b2:	7f cc                	jg     80 <printfile+0x10>
		if (write(1, buf, n) != n) {
	...
	if(n < 0){
  b4:	75 22                	jne    d8 <printfile+0x68>
		printf(1, "cat: read error\n");
		exit();
	}
	close(fd);
  b6:	89 75 08             	mov    %esi,0x8(%ebp)
}
  ...
  be:	5d                   	pop    %ebp
	...
	close(fd);
  bf:	e9 06 03 00 00       	jmp    3ca <close>
{
	int n;
  ...
  cc:	6a 01                	push   $0x1
  ce:	e8 2d 04 00 00       	call   500 <printf>
			exit();
  d3:	e8 ca 02 00 00       	call   3a2 <exit>
		}
	}
	if(n < 0){
		printf(1, "cat: read error\n");
  ...
  e2:	e8 19 04 00 00       	call   500 <printf>
		exit();
  e7:	e8 b6 02 00 00       	call   3a2 <exit>
...
drawHeader() {
  ...
  f6:	68 e0 00 00 00       	push   $0xe0
  fb:	68 60 08 00 00       	push   $0x860
 100:	6a 00                	push   $0x0
 102:	6a 00                	push   $0x0
 104:	e8 49 03 00 00       	call   452 <updatesc>
	updatesc(30, 0, "        PICO        ", UI_COLOR);
 109:	68 e0 00 00 00       	push   $0xe0
 10e:	68 49 08 00 00       	push   $0x849
 113:	6a 00                	push   $0x0
 115:	6a 1e                	push   $0x1e
 117:	e8 36 03 00 00       	call   452 <updatesc>
	updatesc(50, 0, "                         v0.1 ", UI_COLOR);
 11c:	83 c4 20             	add    $0x20,%esp
 11f:	68 e0 00 00 00       	push   $0xe0
 124:	68 80 08 00 00       	push   $0x880
 129:	6a 00                	push   $0x0
 12b:	6a 32                	push   $0x32
 12d:	e8 20 03 00 00       	call   452 <updatesc>
}
...
drawFooter() {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
	updatesc(0, 24, " PRESS ENTER TO CLOSE                                                           ", UI_COLOR);
 146:	68 e0 00 00 00       	push   $0xe0
 14b:	68 a0 08 00 00       	push   $0x8a0
 150:	6a 18                	push   $0x18
 152:	6a 00                	push   $0x0
 154:	e8 f9 02 00 00       	call   452 <updatesc>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49f:	f7 f6                	div    %esi
 4a1:	0f b6 92 fc 08 00 00 	movzbl 0x8fc(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 618:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 61b:	b8 f4 08 00 00       	mov    $0x8f4,%eax
...
free(void *ap)
{
 ...
 6a1:	a1 20 0c 00 00       	mov    0xc20,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6f9:	a3 20 0c 00 00       	mov    %eax,0xc20
}
 6fe:	5b                   	pop    %ebx
 6ff:	5e                   	pop    %esi
 700:	5f                   	pop    %edi
 ...
 71a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 71d:	a3 20 0c 00 00       	mov    %eax,0xc20
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 20 0c 00 00    	mov    0xc20,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 78f:	76 3f                	jbe    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	39 05 20 0c 00 00    	cmp    %eax,0xc20
 ...
 7b6:	e8 e5 fe ff ff       	call   6a0 <free>
  return freep;
 7bb:	8b 15 20 0c 00 00    	mov    0xc20,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7df:	89 15 20 0c 00 00    	mov    %edx,0xc20
      return (void*)(p + 1);
 ...
 7f4:	eb e9                	jmp    7df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7f6:	c7 05 20 0c 00 00 24 	movl   $0xc24,0xc20
 7fd:	0c 00 00 
 800:	c7 05 24 0c 00 00 24 	movl   $0xc24,0xc24
 807:	0c 00 00 
    base.s.size = 0;
 80a:	b8 24 0c 00 00       	mov    $0xc24,%eax
 80f:	c7 05 28 0c 00 00 00 	movl   $0x0,0xc28
 816:	00 00 00 
